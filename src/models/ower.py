...
class Ower(Module):
    ...
    def forward(self, tok_lists_batch: Tensor) -> Tuple[Tensor, Tensor]:
        """
        ...
        return logits_batch, atts_batch
    ...
    def forward_without_attention(self, tok_lists_batch: Tensor) -> Tensor:
        """
